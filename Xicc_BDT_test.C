/// \file
 ...
 int Xicc_BDT_test( TString myMethodList = "" )
 {
    ...
    TFile *inputSignal(0);
    TString fnamesig = "/Users/mohammad/alice/mergeddata/signalallcombinedprecut209/Xicc_binned_signal.root"; 
    ...
    TString fnamebkg = "/Users/mohammad/alice/mergeddata/bbbarprecuts1800/Xicc_binned_bkg.root"; 
    ...
    // for for loop (binning)
    if (i == 0 ){ mycuts= "fPt > 4.0 && fPt < 6.0 && fM< 3.8 && fM >3.4";}
    else if (i == 1){ mycuts= "fPt > 6.0 && fPt < 14.0 && fM< 3.8 && fM >3.4";}
